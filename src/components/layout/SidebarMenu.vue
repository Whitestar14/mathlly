...
import NavigationCategory from "@/components/layout/NavigationCategory.vue";
import FooterNavigationItem from "@/components/layout/FooterNavigationItem.vue";
import type { NavigationItem } from "@/composables/useSidebarNavigation";
