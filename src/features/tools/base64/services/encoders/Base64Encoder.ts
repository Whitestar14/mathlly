import type { Base64ServiceType, Base64EncodingOptions, Base64EncodingResult, IBase64Encoder, Base64DecodingOptions, Base64DecodingResult } from '@base64/types/base64'
import { applyFormat } from '@base64/utils/formatters/base64Formatter'
