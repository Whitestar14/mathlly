  ...
  <BaseCard>
    ...
    <template #head>
      <div class="flex items-center gap-2">
        ...
        <span class="mx-1 h-[10px] w-px bg-border/60" aria-hidden="true" />
    ...
    <div class="space-y-6">
      ...
      <div class="space-y-3">
        <div class="flex items-center justify-between">
          <BaseLabel class="text-sm font-medium">Live preview</BaseLabel>
      ...
      <BaseAccordion :multiple="true" default-value="['colors','settings']" class="space-y-0">
        <!-- Color Controls - Primary interaction -->
        <AccordionItem id="colors" title="Color controls">
          <div class="space-y-4">
        ...
        <AccordionItem id="settings" title="Advanced settings">
          <div class="space-y-6">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
              ...
              <div class="space-y-2">
                ...
                <BaseSlider
                  ...
                  class="w-full"
                />
                <p class="text-xs text-muted-foreground">Controls how many color stops are generated</p>
              </div>
              ...
              <div class="space-y-2">
                ...
                <BaseSlider
                  :model-value="[angle]"
                  @update:modelValue="v => setAngle(v[0])"
                  :min="0"
                  :max="360"
                  :step="1"
                  class="w-full"
                />
                <p class="text-xs text-muted-foreground">Direction of the gradient in degrees</p>
              </div>
            </div>
          </div>
        </AccordionItem>
