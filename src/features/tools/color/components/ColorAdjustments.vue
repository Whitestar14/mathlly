...
<template>
  <div class="space-y-4">
    <div class="space-y-2">
      <BaseLabel class="text-sm font-medium">Brightness: {{ brightness }}</BaseLabel>
      <div class="flex items-center gap-2">
        ...
        />
        <BaseButton size="sm" variant="ghost" @click="applyBrightness(currentColor)">
          Apply
        </BaseButton>
      </div>
    </div>
    ...
    <div class="space-y-2">
      <BaseLabel class="text-sm font-medium">Saturation: {{ saturation.toFixed(2) }}</BaseLabel>
      <div class="flex items-center gap-2">
        <BaseSlider
        ...
        />
        <BaseButton size="sm" variant="ghost" @click="applySaturation(currentColor)">
          Apply
        </BaseButton>
      </div>
    </div>
    ...
    <div class="pt-2">
      <BaseButton size="sm" variant="outline" @click="applyContrast(currentColor)">
