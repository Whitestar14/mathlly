...
export class SpecialOperationHandler {
  ...
  handleAbsoluteOperation(): Record<string, any> {
    try {
      ...
      return this.createResponse(CalculatorUtils.formatError(err, "Absolute value operation failed"));
    }
  }
  ...
  handleFactorialOperation(): Record<string, any> {
    try {
      ...
      // Check if input ends with a number, closing parenthesis, or constant
      ...
      if (lastValidMatch) {
        ...
        const operatorMatch = trimmedInput.match(/^(.*[+\-×÷\s])([^+\-×÷\s]+)$/)
      ...
      return this.createResponse(CalculatorUtils.formatError(err, "Factorial operation failed"));
    }
  }
  ...
  handleModuloOperation(): Record<string, any> {
    try {
      ...
      return this.createResponse(CalculatorUtils.formatError(err, "Modulo operation failed"));
    }
  }
  ...
  handleRandomOperation(): Record<string, any> {
    try {
      ...
      return this.createResponse(CalculatorUtils.formatError(err, "Random operation failed"));
    }
  }
  ...
  handleDMSOperation(): Record<string, any> {
    try {
      ...
      return this.createResponse(CalculatorUtils.formatError(err, "DMS operation failed"));
    }
  }
  ...
  handleDegreeOperation(): Record<string, any> {
    try {
      ...
      return this.createResponse(CalculatorUtils.formatError(err, "Degree operation failed"));
    }
  }
