<template>
  <BasePage
    ...
    <section class="space-y-6 mx-auto max-w-4xl mb-12">
      <div class="flex items-center justify-between mb-8">
        <div class="flex items-center">
          <div class="relative flex items-center">
            ...
            <div class="absolute left-5 top-10 bottom-0 w-px h-12 bg-primary/30"></div>
          </div>
      ...
      <div class="relative">
        <div class="absolute left-0 top-0 bottom-0 w-px bg-primary/30 ml-5"></div>
        ...
        <div class="grid gap-8 pl-10">
          <div
            ...
            <div class="absolute -left-7 top-6 h-4 w-4 bg-primary rounded-full z-5 border-4 border-background"></div>
